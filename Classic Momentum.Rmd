...
3. Be able to balence and compute the momentum on objects.
...
**Inelastic Collision:** An inelastic collision, in contrast to an elastic collision, is a collision in which momentum and kinetic energy is not conserved due to the action of internal friction.
...
Two cars are barreling towards another car in a future ellastic collision. There masses and velocities are listed below. Lets use R to calculate the total mass of the system!
